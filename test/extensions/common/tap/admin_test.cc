...
// default) as this would trigger a seg fault.
...
// case trigger a NPE accessing the attached request.
//
...
// request. If handled improperly, this case trigger a NPE accessing the attached request.
//
